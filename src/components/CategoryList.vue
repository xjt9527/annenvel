<template>
  <div class="imgsort-list">
    <div class="page-filter">
      <el-button type="success" @click="addBtn">新增分类</el-button>
    </div>
    <el-table :data="tableData" style="width: 100%" size="middle" border stripe>
      ...
      <el-table-column label="分类图片预览" align="center">
        <template slot-scope="scope">
          <img :src="scope.row.categoryImageUrl + '?x-oss-process=image/resize,w_200'" width="100" />
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" width="100" align="center">
        <template slot-scope="scope">
          <el-button size="small" type="primary" plain @click="editBtn(scope.row.categoryId)">修改</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-dialog title="新增分类" :visible.sync="showPop" width="600px">
      ...
      <div slot="footer" class="dialog-footer" style="text-align:center;">
        ...
        <el-button type="primary" @click="addGoodSort">确 定</el-button>
      </div>
    </el-dialog>

    <el-dialog title="修改分类" :visible.sync="showPop2" width="600px">
      ...
      <div slot="footer" class="dialog-footer" style="text-align:center;">
        <el-button @click="showPop2 = false">取 消</el-button>
        <el-button type="primary" @click="editGoodSort">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    editBtn(id) {
      ...
      new API(this).POST({
        url: "/goodsCategory/getGoodsCategoryDetail?categoryId=" + id,
        cb: res => {
          this.editForm = res;
          this.showPop2 = true;
    ...
    addGoodSort() {
      let { categoryImageKey, categoryName } = this.form;
